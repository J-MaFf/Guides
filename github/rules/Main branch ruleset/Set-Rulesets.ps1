...
Rulesets include: required pull requests, conversation resolution, no force pushes, and required status checks (test and markdown linting).
...
Write-Host "✓ Require status checks: test, lint-markdown (enforces code quality)"
